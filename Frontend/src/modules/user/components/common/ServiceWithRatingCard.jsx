...
const ServiceWithRatingCard = memo(({ image, title, rating, reviews, price, originalPrice, discount, onClick, onAddClick }) => {
  ...
  return (
    <div
      className="min-w-[145px] w-[145px] sm:min-w-[160px] sm:w-[160px] bg-white rounded-2xl overflow-hidden cursor-pointer border border-slate-100 shadow-[0_2px_8px_-2px_rgba(0,0,0,0.04)] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group flex flex-col"
      onClick={onClick}
    >
      ...
      <div className="p-2.5 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between mt-auto pt-1">
          ...
          <button
            ...
            className="px-2.5 py-1 rounded-lg text-[11px] font-bold transition-all active:scale-95 border leading-none"
            style={{
